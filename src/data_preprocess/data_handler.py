...
class DataHandler:
    ...
    def get_on_data(self):
        ...
        if self.ds is None:
            df = self.load_dataset(self.data_path)
            self.ds = self.data_splitter_class(df, self.timestamp_col, self.power_col) 
            self.ds.set_data_split(self.training_days, self.val_days, self.test_days)
    ...
    def get_train_data(self):
        ...
        self.train_df = self.ds.generate_train_data()
    ...
    def get_val_data(self):
        ...
        self.val_df = self.load_dataset(self.val_data_path)
        if self.val_df is not None:
            return self.val_df
        ...
        self.val_df = self.ds.generate_val_data()
    ...
    def get_test_data(self):
        ...
        self.test_df = self.ds.generate_test_data()
