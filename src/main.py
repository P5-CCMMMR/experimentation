...
def main(d):
    ...
    if (isinstance(model, ProbabilisticPipeline)):
        print("PROB MAFE ON:", get_prob_mafe(on_data_arr, model, seq_len, error, temp_boundary, time_horizon, TARGET_COLUMN, flex_confidence))
        print("PROB MAFE OFF:", get_prob_mafe(off_data_arr, model, seq_len, error, temp_boundary, time_horizon, TARGET_COLUMN, flex_confidence))
    else:
        print("MAFE ON:", get_mafe(on_data_arr, model, seq_len, error, temp_boundary, time_horizon, TARGET_COLUMN))
        print("MAFE OFF:", get_mafe(off_data_arr, model, seq_len, error, temp_boundary, time_horizon, TARGET_COLUMN))
